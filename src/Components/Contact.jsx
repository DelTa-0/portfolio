  ...
  const social = [
    {
      name: "LinkedIn",
      icon: <FaLinkedinIn />,
      link: "https://www.linkedin.com/in/madhav-aryal-aab090308/",
    },
    {
      name: "Github",
      icon: <FaGithub />,
      link: "https://github.com/DelTa-0",
    },
  ];
  
  return (
    <div id="contact" className="h-screen w-full relative">
      ...
      <div className="cotactcontent flex flex-col-reverse lg:flex-row px-6 md:px-12 h-full w-full absolute z-[0]">
        ...
        <div className="rightpart h-[60%] lg:h-full flex flex-col pb-8 lg:pb-20 justify-end w-full lg:w-[50%] ">
          ...
          >
            ...
            <div className="skillset">
              <h2 className="font-[satoshiregular]">aryalmadhave123@example.com</h2>
            </div>
          </a>
        </div>
      </div>
