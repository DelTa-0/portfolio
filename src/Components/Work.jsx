...
function Work() {
  ...
  var overcontent = [
    {
      description:
        "Built a fully functional premium bag site with authentication and product management. Implemented secure user login, product listing, and shopping cart features. Integrated payment gateway for seamless transactions and developed an admin panel for managing products and orders.",
      tools: ["Node.js", "Express.js", "MongoDB", "JWT"],
      img1: chitralok1,
      live: "https://your-ecommerce-project.com",
    },
    {
      description:
        "AI-powered code assistant using Node.js, Express, and Gemini API.Implemented code generation, explanation, and bug-fixing features",
    ...
    {
      description:
        "Developed a full-stack web app for listing and selling used products.",
      tools: [ "Python", "Django"],
      img1: obys1,
      live: "https://your-second-hand-marketplace.com",
    },
  ...
  return (
    <div id="work" className="works w-full  bg-black relative  flex items-center justify-center">
      ...
      <div className="page3container p-6  md:p-12 h-screen w-full top-0 left-0 z-[2] absolute ">
        <div className="main flex flex-col-reverse lg:flex-row  opacity-[1] h-full w-full   ">
          <div className="main-col h-[50%] w-full lg:h-full lg:w-[50%] flex items-center justify-center">
            <div className="main-img-list relative h-[60vw] w-[46vw] lg:h-[35vw] lg:w-[25vw] rounded-md overflow-hidden">
              {imgSrc.map((elem, idx) => {
                return (
                  <div
                    key={idx}
        ...
        <div className="overlay  h-[140vh] lg:h-screen w-full pointer-events-none top-0 left-0 absolute z-[4] ">
          {overcontent.map((elem, idx) => {
            return (
              ...
              >
                  ...
                  <div
                    data-overlay="text-target"
                    className="overlay-text-wrap text-center leading-[1.05] text-white text-[12vw] py-6 md:py-10 lg:py-14 md:text-[8vw] lg:text-[6vw] w-full h-[30%] flex items-center justify-center"
                  ></div>
                  <div
                    data-overlay="img-target"
                    className="overlay-img-wrap h-[100%] w-[80%] md:h-[75%] md:w-[50%] lg:h-[55%] lg:w-[35%] transition-all duration-300"
                  ></div>
                </div>
                <div className="overlay-row px-6 md:px-12 pt-12 lg:pb-12 bg-[#091018] h-full w-full">
                  <div className="rowpart w-full flex flex-col lg:flex-row items-center justify-center">
                    <div className="rowchild flex flex-col md:flex-row items-start justify-between text-white h-full w-full lg:w-[85%]">
                      <div className="textsection flex flex-col gap-8 justify-center h-full w-full md:w-[60%] pr-4 md:pr-8">
                        <div>
                          <h1 className="text-3xl lg:text-4xl font-semibold mb-4">
                            Description
                          </h1>
                          <p className="text-lg md:text-xl font-[helvetica] text-pretty leading-relaxed text-gray-200">
                            {elem.description}
                          </p>
                        </div>
                        <div>
                          ...
                          <ul className="text-gray-200 flex flex-wrap gap-3">
                            {elem.tools.map((e, id) => (
                              <li key={id} className="bg-gray-800 px-4 py-2 rounded-full text-sm md:text-base hover:bg-gray-700 transition-colors">
                                {e}
                              </li>
                            ))}
                          </ul>
          ...
          <div className="overlay-nav pointer-events-auto absolute px-12 z-[4] top-[38%] lg:bottom-[10%] left-0 right-0 overflow-hidden items-center justify-between hidden">
            <h3
