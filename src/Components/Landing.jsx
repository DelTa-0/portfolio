...
function Landing({ finish }) {
  ...
  useGSAP(() => {
    // Initialize about page in the correct starting position and background
    gsap.set(".aboutpage", {
      y: "100%",
      backgroundColor: "black",
    });

    // Animate about page with improved transition
    tl3.to(".aboutpage", {
      y: "0%",
      backgroundColor: "black",
      duration: 1,
    ...
    <div className="pare h-screen w-full">
      <div className="landingcontainer h-full relative w-full ">
        ...
        <div className="availability absolute left-[50%] translate-x-[-50%] top-[16%] md:top-[12%] lg:top-[13%]">
          <div className="available group transition-all duration-300 hover:scale-[1.02] cursor-pointer gap-4 md:gap-6 backdrop-blur-md bg-white/10 hover:bg-white/20 border border-white/20 rounded-full items-center px-6 md:px-8 py-4 flex shadow-lg">
            <div className="dot h-2.5 w-2.5 bg-green-400 rounded-full animate-pulse shadow-[0_0_12px_rgba(74,222,128,0.6)] group-hover:shadow-[0_0_16px_rgba(74,222,128,0.8)]"></div>
            <h1 className="text-md md:text-lg font-[satoshibold] tracking-wide text-white/90 group-hover:text-white">
              Available for work
            </h1>
          </div>
        </div>
  ...
  <div id="about" className="aboutpage bg-black translate-y-[100%] h-full w-full z-[10] absolute top-0 left-0 overflow-hidden">
          <div className="aboutpagecontainer h-full w-full relative bg-black">
            <div className="bgImage h-full w-full ">
              <img
                className="h-full w-full object-cover"
                src={bgImage1}
            ...
            <div className="aboutcontent flex flex-col-reverse md:flex-row justify-between h-full w-full absolute top-0 left-0  px-6 md:px-12 ">
              ...
              <div className="aboutsection  flex flex-col jusitfy-end pt-8 lg:pt-16 gap-3 h-[68%] lg:h-full w-full md:w-[50%] text-white ">
                ...
                <div className="about mt-3 md:mt-0 overflow-hidden text-[4vw] md:text-[2.3vw] lg:text-[1.4vw] ">
                  ...
                  >
                    Namaste! I'm Your Madhav Aryal, a Full Stack Developer with expertise in building scalable web applications 
                    using modern technologies. With a strong foundation in both frontend and backend development, 
                    I specialize in creating robust, efficient solutions that solve real-world problems. 
                    My experience spans across the entire development stack - from crafting intuitive user interfaces 
                    with React to designing and implementing secure backend systems with Node.js and Python. 
                    I'm particularly passionate about creating performant applications that provide exceptional 
